...
public class inputManager : MonoBehaviour {
	...
	private void fetchData() {
		m_saturation = MidiMaster.GetKnob(41);
		m_gravity = MidiMaster.GetKnob(42);
		m_timeSpeed = MidiMaster.GetKnob(43);
		m_lightIntensity = MidiMaster.GetKnob(44);
		m_soundPitch = MidiMaster.GetKnob(45);
		m_normalIntensity = MidiMaster.GetKnob(46);
	}
