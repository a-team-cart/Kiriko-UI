...
public class inputManager : MonoBehaviour {
	...
	private void fetchData() {
		m_saturation = MidiMaster.GetKnob(1);
		m_gravity = MidiMaster.GetKnob(2);
		m_timeSpeed = MidiMaster.GetKnob(3);
		m_lightIntensity = MidiMaster.GetKnob(4);
		m_soundPitch = MidiMaster.GetKnob(5);
		m_normalIntensity = MidiMaster.GetKnob(6);
	}
